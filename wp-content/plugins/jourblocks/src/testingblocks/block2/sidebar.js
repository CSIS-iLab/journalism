window.addEventListener("DOMContentLoaded", () => {
  var audioPlayer = document.getElementsByClassName("green-audio-player");
  //console.log(audioPlayer.length);
  var playPause = document.getElementById("playPause");
  var playpauseBtn = document.getElementsByClassName("play-pause-btn");
  var loading = document.getElementsByClassName("loading");
  var progress = document.getElementsByClassName("progress");
  var sliders = document.getElementsByClassName("slider");
  var volumeBtn = document.getElementsByClassName("volume-btn");
  var volumeControls = document.getElementsByClassName("volume-controls");
  var volumeProgress = document.getElementsByClassName("slider .progress");
  var player = document.getElementsByTagName("audio");
  var currentTime = document.getElementsByClassName("current-time");
  var totalTime = document.getElementsByClassName("total-time");
