...
vc_map( array(
    ...
    "params"   => array(
        ...
        array(
            ...
            "holder"      => "div",
            "class"       => "",
            "heading"     => __( "Attribution Name" ),
            "param_name"  => "quote_source",
            "value"       => __( "" ),
            "description" => __( "" ),
            'dependency'  => array(
                'element' => 'style',
        ...
        array(
            ...
            "holder"      => "div",
            "class"       => "",
            "heading"     => __( "Attribution Description" ),
            "param_name"  => "quote_desc",
            "value"       => __( "" ),
            "description" => __( "" ),
            'dependency'  => array(
                'element' => 'style',
        ...
        array(
            ...
            "holder"      => "div",
            "class"       => "",
            "heading"     => __( "Image Vertical Position" ),
            "param_name"  => "imgverpos",
            'value'       => array(
                __( 'Top' )    => 'top',
                __( 'Middle' ) => 'center',
                __( 'Bottom' ) => 'bottom',
        ...
        array(
            ...
            "holder"      => "div",
            "class"       => "",
            "heading"     => __( "Image Horizontal Position" ),
            "param_name"  => "imghorizpos",
            'value'       => array(
                __( 'Right' )  => 'right',
                __( 'Center' ) => 'center',
                __( 'Left' )   => 'left',
...
vc_add_param( 'vc_raw_html', $attributes ); 
...
vc_add_param( 'vc_video', $attributes ); 
...
vc_add_param( 'vc_video', $attributes ); // Note: 'vc_message' was used as a base for "Message box" element
