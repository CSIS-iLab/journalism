<?php
	...
	function modernjournalist_cpt_themes()
	{
		...
		$labels = array(
			'name'                  => _x( 'Issues', 'Post Type General Name', 'modern-journalist' ),
			'singular_name'         => _x( 'Issue', 'Post Type Singular Name', 'modern-journalist' ),
			'menu_name'             => __( 'Issues', 'modern-journalist' ),
			'name_admin_bar'        => __( 'Issues', 'modern-journalist' ),
			'archives'              => __( 'Issues Archives', 'modern-journalist' ),
			'attributes'            => __( 'Issues Attributes', 'modern-journalist' ),
			'parent_item_colon'     => __( 'Parent Issue', 'modern-journalist' ),
			'all_items'             => __( 'All Issues', 'modern-journalist' ),
			'add_new_item'          => __( 'Add New Issue', 'modern-journalist' ),
			'add_new'               => __( 'Add Issue', 'modern-journalist' ),
			'new_item'              => __( 'New Issue', 'modern-journalist' ),
			'edit_item'             => __( 'Edit Issue', 'modern-journalist' ),
			'update_item'           => __( 'Update Issue', 'modern-journalist' ),
			'view_item'             => __( 'View Issue', 'modern-journalist' ),
			'view_items'            => __( 'View Issue', 'modern-journalist' ),
			'search_items'          => __( 'Search Issue', 'modern-journalist' ),
			...
			'insert_into_item'      => __( 'Insert into Issue', 'modern-journalist' ),
			'uploaded_to_this_item' => __( 'Uploaded to this Issue', 'modern-journalist' ),
			'items_list'            => __( 'Issues list', 'modern-journalist' ),
			'items_list_navigation' => __( 'Issues list navigation', 'modern-journalist' ),
			'filter_items_list'     => __( 'Filter Issues list', 'modern-journalist' ),
		);
		$args = array(
			'label'               => __( 'Issue', 'modern-journalist' ),
			'description'         => __( 'Issues', 'modern-journalist' ),
			'labels'              => $labels,
...
<?php
	...
	function themes_save_meta_box_data( $post_id )
	{
		...
		if ( !isset( $_POST['themes_meta_box_nonce'] ) || !wp_verify_nonce( sanitize_key( wp_unslash( $_POST['themes_meta_box_nonce'] ) ), basename( __FILE__ ) ) ) {
			// Input var okay.
			return;
		}
		// Return if autosave.
