...
jQuery(document).ready(function($) {
    ...
    $(document).on('click', '.choose-meta-image-button', function(e) {
        ...
        meta_image_frame.on('select', function() {
            ...
            $('.image_container[data-id="' + $thisname + '"]').html("<img src='" + image_value + "' style='width:200px;height:auto;cursor:pointer;' class='choose-meta-image-button' name='" + $thisname + "' title='Change Image' /><br /><input type='button' class='remove-meta-image-button button' data-id='" + $thisname + "'  value='Remove Image' />");
        });
